...
import com.store.pageObject.Product_6_Description;
...
public class TC_BuyProduct_6 extends BaseClass
{
	@Test
	
	public void buyProduct_6() throws InterruptedException, IOException
	{
		
		logger.info("\n********************TEST CASE BUY PRODUCT 6 STARTED*********************");
		...
		Product_6_Description pd3 = new Product_6_Description(driver);
		...
		{
			logger.info("*****buyProduct_6 Passed*****");
			Assert.assertTrue(true);
		}
		else
		{
			logger.info("******buyProduct_6 failed******");
			captureScreenShot(driver,"TC_BuyProduct_6");
