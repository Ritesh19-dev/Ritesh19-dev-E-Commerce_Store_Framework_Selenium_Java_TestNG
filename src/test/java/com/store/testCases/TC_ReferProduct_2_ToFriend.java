...
public class TC_ReferProduct_2_ToFriend extends BaseClass
{
	@Test

	public void referProduct_2() throws InterruptedException, IOException 
	{


		logger.info("\n********************TEST CASE REFER PRODUCT 2 TO FRIEND STARTED*********************");
		...
		else
		{
			...
			captureScreenShot(driver,"TC_ReferProduct_2_ToFriend");
			Assert.assertTrue(false);
		}

		logger.info("\n********************TEST CASE REFER PRODUCT 2 TO FRIEND ENDS*********************");
	}
