...
public class TC_ReferProduct_3_ToFriend extends BaseClass
{
	@Test

	public void referProduct_3() throws InterruptedException, IOException 
	{


		logger.info("\n********************TEST CASE REFER PRODUCT 3 TO FRIEND STARTED*********************");
		...
		else
		{
			...
			captureScreenShot(driver,"TC_ReferProduct_3_ToFriend");
			Assert.assertTrue(false);
		}

		logger.info("\n********************TEST CASE REFER PRODUCT 3 TO FRIEND ENDS*********************");
	}
