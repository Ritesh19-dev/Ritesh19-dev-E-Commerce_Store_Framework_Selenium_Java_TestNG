...
public class TC_ReferProduct_4_ToFriend extends BaseClass
{
	@Test

	public void referProduct_4() throws InterruptedException, IOException 
	{


		logger.info("\n********************TEST CASE REFER PRODUCT 4 TO FRIEND STARTED*********************");
		...
		else
		{
			...
			captureScreenShot(driver,"TC_ReferProduct_4_ToFriend");
			Assert.assertTrue(false);
		}

		logger.info("\n********************TEST CASE REFER PRODUCT 4 TO FRIEND ENDS*********************");
	}
