...
public class TC_ReferProduct_5_ToFriend extends BaseClass
{
	@Test

	public void referProduct_5() throws InterruptedException, IOException 
	{


		logger.info("\n********************TEST CASE REFER PRODUCT 5 TO FRIEND STARTED*********************");
		...
		else
		{
			...
			captureScreenShot(driver,"TC_ReferProduct_5_ToFriend");
			Assert.assertTrue(false);
		}

		logger.info("\n********************TEST CASE REFER PRODUCT 5 TO FRIEND ENDS*********************");
	}
