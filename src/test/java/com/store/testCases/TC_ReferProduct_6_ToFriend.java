...
public class TC_ReferProduct_6_ToFriend extends BaseClass
{
	@Test
	
	public void referProduct() throws InterruptedException, IOException 
	{


		logger.info("\n********************TEST CASE REFER PRODUCT 6 TO FRIEND STARTED*********************");
		...
		else
		{
			...
			captureScreenShot(driver,"TC_ReferProduct_6_ToFriend");
			Assert.assertTrue(false);
		}
		
		logger.info("\n********************TEST CASE REFER PRODUCT 6 TO FRIEND ENDS*********************");
	}
